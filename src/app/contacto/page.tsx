        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-10">
          <div className="flex items-center gap-4 bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
            ...
            <div>
              ...
              <a href="mailto:contacto@mediofertas.co" className="text-sm font-semibold text-primary-600 hover:underline">
              ...
              {estado === "error" && (
                <div className="bg-red-50 border border-red-100 rounded-xl px-4 py-3">
                  <p className="text-sm text-red-600">
                    ...
                    <a href="mailto:contacto@mediofertas.co" className="font-semibold underline">
                      contacto@mediofertas.co
                    </a>
                    .
                  </p>
